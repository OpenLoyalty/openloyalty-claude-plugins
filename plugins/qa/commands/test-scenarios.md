...
4. Add metadata footer: `Generated by /qa:test-scenarios | {date} | {scenario_count} scenarios`
...
- `/engineering:review-pr` — Code review with OL conventions
- `/engineering:jira-ticket-breakdown` — Break features into Jira hierarchy
