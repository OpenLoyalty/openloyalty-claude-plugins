...
**Usage:** `/ol:winning-plan ticketmaster`
...
- **company_name** — from the argument (e.g., `ticketmaster` from `/ol:winning-plan ticketmaster`)

**Validation:** If no company name provided, ask:
```
Please provide a company name. Usage: /ol:winning-plan <company-name>
```
...
**User:** `/ol:winning-plan INTERSPORT Elverys`
