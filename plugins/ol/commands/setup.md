...
The Open Loyalty plugin requires the [compound-engineering](https://github.com/EveryInc/compound-engineering-plugin) plugin for review workflows and specialized agent types used by `/ol:review-pr`.
...
Then restart Claude Code and run /ol:setup again.
```
