---
name: openloyalty:qa:test-scenarios
...
4. Add metadata footer: `Generated by /openloyalty:qa:test-scenarios | {date} | {scenario_count} scenarios`
...
- `/openloyalty:jira-ticket-breakdown` — Break features into Jira hierarchy
